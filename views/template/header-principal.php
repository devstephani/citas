                ...
                <nav class="navbar navbar-expand-md navbar-light">
                    <div class="container">
                        <a class="navbar-brand" href="<?php echo RUTA_PRINCIPAL ; ?>">
                            <img src="<?php echo RUTA_PRINCIPAL . 'assets'; ?>/img/logo.jpg" width="60" alt="Logo">
                        </a>
                        <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            <ul class="navbar-nav m-auto">

                            <li class="nav-item">
                                    <a href="<?php echo RUTA_PRINCIPAL . 'servicios'; ?>" class="nav-link ">
                                      Servicios
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a href="<?php echo RUTA_PRINCIPAL . 'paquetes'; ?>" class="nav-link active">
                                        Paquetes
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo RUTA_PRINCIPAL . 'probador'; ?>" class="nav-link ">
                                       Probador virtual
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo RUTA_PRINCIPAL . 'cerrar_sesion'; ?>" class="nav-link active">
                                       cerar sesion
                                    </a>
                                </li>
