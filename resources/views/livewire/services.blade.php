            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-6">
                        <div class="single-rooms-three-wrap">
                            <div class="single-rooms-three">
                                <img src="{{ asset('img/rooms/5.jpg') }}" alt="Image">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="single-rooms-three-wrap">
                            <div class="single-rooms-three">
                                <img src="{{ asset('img/rooms/6.jpg') }}" alt="Image">
                                <div class="single-rooms-three-content">
                                    <h3>Double Room</h3>
                                    <ul class="rating">
                                        <li>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="single-rooms-three-wrap">
                            <div class="single-rooms-three">
                                <img src="{{ asset('img/rooms/7.jpg') }}" alt="Image">
                                <div class="single-rooms-three-content">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="single-rooms-three-wrap">
                            <div class="single-rooms-three">
                                <img src="{{ asset('img/rooms/8.jpg') }}" alt="Image">
                                <div class="single-rooms-three-content">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="single-rooms-three-wrap">
                            <div class="single-rooms-three">
                                <img src="{{ asset('img/rooms/9.jpg') }}" alt="Image">
                                <div class="single-rooms-three-content">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="single-rooms-three-wrap">
                            <div class="single-rooms-three">
                                <img src="{{ asset('img/rooms/10.jpg') }}" alt="Image">
                                <div class="single-rooms-three-content">
                                    <h3>Budget Room</h3>
                                    <ul class="rating">
                                        <li>
                    ...
                    @foreach ($services as $service)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            <th scope="row"
                                ...
                                <img src="{{ asset('storage/' . $service->image) }}" class="size-20" />
                            </th>
                            <td class="px-6 py-4">
                                {{ $service->name }}
                            </td>
