...
<head>
    ...
    <title>Reporte de servicios y paquetes de usuario</title>
                            ...
                            @foreach ($data as $item)
                                <tr>
                                    <td class="text-center">
                                        <h6>{{ \Carbon\Carbon::createFromFormat('Y-m-d h:i:s', $item->picked_date)->format('d-m-Y h:i a') }}
                                        </h6>
                                    </td>
                                    <td class="text-center">
                                        <h6>{{ $item->status ? 'Pagado' : 'Pendiente' }}</h6>
                                    </td>
                                    <td class="text-center">
                                        <h6>{{ $item->user->name }}
                                        </h6>
                                    ...
                                    <td class="text-center">
                                        <h6>{{ $item->service->name ?? $item->package->name }}
                                        </h6>
                                    </td>
                                    <td class="text-center">
                                        <h6>{{ ($item->service->price ?? $item->package->price) * ($item->discount ? 0.95 : 1) }}$
                                        </h6>
                                    </td>
                                    <td class="text-center">
                                        @php
