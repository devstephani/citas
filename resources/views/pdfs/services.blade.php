                        ...
                        <tbody>
                            @foreach ($services as $service)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <h6>{{ $service->status ? 'Pagado' : 'Pendiente' }}</h6>
                                    </td>
                                    <td class="text-center">
                                        <h6>{{ $service->user->name }}
                                        </h6>
                                    </td>
                                    <td class="text-center">
                                        <h6>{{ $service->service->name }}
                                        </h6>
                                    </td>
                                    <td class="text-center">
                                        <h6>{{ $service->service->price * ($service->discount ? 0.95 : 1) }}$
                                        </h6>
                                    </td>
                                    <td class="text-center">
                                        @php
                                            $currency = $service->payment->currency->name ?? '';
                                            $payed = $service->payment->payed ?? '';
                                        @endphp
                                        <h6>{{ "$currency $payed" }}
                                        </h6>
                                    </td>
